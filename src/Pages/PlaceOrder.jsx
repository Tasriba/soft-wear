        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            >
              ...
              <img className='h-10 mx-4' src={assets.stripe_logo} alt="" />
            </div>
            ...
            >
              ...
              <img className='h-10 mx-4' src={assets.razorpay_logo} alt="" />
            </div>
            ...
            >
              ...
              <p className='text-pink-500 text-sm font-medium mx-4'>
                CASH ON DELIVERY
              </p>
            </div>
          ...
          <div className='w-full text-end mt-8'>
            <button
              type='submit'
              className='bg-pink-400 text-black px-16 py-3 text-sm'
            >
              PLACE ORDER
            </button>
          </div>
